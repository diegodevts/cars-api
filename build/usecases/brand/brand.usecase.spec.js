...
var UpdateBrandUseCase = class {
  ...
  async handle(data, id2) {
    const updatedBrand = await this.genericRepository.update(data, id2);
    if (!updatedBrand) {
      throw new ResourceNotFoundError();
    }
    return updatedBrand;
...
// src/usecases/brand/brand.usecase.spec.ts
var brandRepository;
var createUseCase;
var findUseCase;
var updateUseCase;
